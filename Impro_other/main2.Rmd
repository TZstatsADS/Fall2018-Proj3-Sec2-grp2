...
run.hog.feature.train=TRUE
run.rgb.feature.train=TRUE
run.canny.feature.train=TRUE
run.diagonal.feature.train=TRUE
...
```{r}
tm_feature_hog<-NA
if(run.hog.feature.train){
  tm_feature_hog<-system.time(dat_train<-feature_hog(train_LR_dir,train_HR_dir))
  feat_train<-dat_train$feature
  label_train<-dat_train$label
}
...
```{r}
tm_feature_rgb<-NA
if(run.rgb.feature.train){
  tm_feature_rgb<-system.time(dat_train<-feature_rgb(train_LR_dir,train_HR_dir))
  feat_train<-dat_train$feature
  label_train<-dat_train$label
}
...
```{r}
tm_feature_canny<-NA
if(run.canny.feature.train){
  tm_feature_canny<-system.time(dat_train<-feature_canny(train_LR_dir,train_HR_dir))
  feat_train<-dat_train$feature
  label_train<-dat_train$label
}
...
```{r}
tm_feature_diagonal<-NA
if(run.diagonal.feature.train){
  tm_feature_diagonal<-system.time(dat_train<-feature_diagonal(train_LR_dir,train_HR_dir))
  feat_train<-dat_train$feature
  label_train<-dat_train$label
}
