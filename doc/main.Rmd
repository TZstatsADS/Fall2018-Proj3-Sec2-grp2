---
title: "Project 3 - Baseline(GBM) and Improved(XGBoost with Canny feature) models"
author: "Grp2"
output:
...
```{r runcv, message=FALSE, warning=FALSE, results="hide"}
...
```
###XGBOOST
```{r final_train_xgboost, message=FALSE, warning=FALSE}
if(run.train){
...
```{r running_time}
cat("Time for constructing training features=", tm_feature_train, "s \n")
cat("Time for training gbm model=", tm_train_gbm, "s \n")
cat("Time for gbm super-resolution=", tm_test_gbm, "s \n")
cat("Time for training xgboost model=", tm_train_xgboost, "s \n")
cat("Time for xgboost super-resolution=", tm_test_xgboost, "s \n")
